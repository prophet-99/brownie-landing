...
!function(a, b) {
  ...
  window.SplitType = function(a, b, c) {
      ...
      function y(a, b, d) {
          var i, h = {};
          return r(a) && (i = a[e] || (a[e] = ++g),
          h = f[i] || (f[i] = {})),
          d === c ? b === c ? h : h[b] : b !== c ? (h[b] = d,
          d) : void 0
      }
      function z(a) {
          var b = a && a[e];
      ...
      function C(b) {
          ...
          r = f.split(" ").map(function(a) {
              if (a === e)
                  return x.appendChild(A("br")),
                  null;
              if (l) {
          ...
          m || j) {
              ...
              w(H, function(a) {
                  if (a !== x) {
                      ...
                      j && b && (c = y(a).top = a.offsetTop,
                      c !== C && (C = c,
                      z.push(B = [])),
                      B.push(a)),
                      m && (y(a).top = c || a.offsetTop,
              ...
              m && (b.style.width = b.style.width || G + "px",
              b.style.height = F + "px",
              w(H, function(a) {
                  var b = "line" === y(a).type
                    , c = !b && "line" === y(a.parentElement).type;
                  a.style.top = c ? 0 : y(a).top + "px",
                  a.style.left = b ? E.left + "px" : (c ? y(a).left - E.left : y(a).left) + "px",
      ...
      function D(a, b) {
          return this instanceof D ? (this.isSplit = !1,
          this.settings = x(q, b),
          this.elements = B(a),
          void (this.elements.length && (this.originals = this.elements.map(function(a) {
      ...
      if (b.addEventListener && Function.prototype.bind) {
          ...
          D.prototype.revert = function() {
              ...
              w(this.elements, function(a) {
                  y(a).isSplit && y(a).html && (a.innerHTML = y(a).html,
